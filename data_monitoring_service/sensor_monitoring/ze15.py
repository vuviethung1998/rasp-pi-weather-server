# datasheet: https://www.winsen-sensor.com/d/files/ZE15-CO.pdf

# Note: The module will automatically switch to Q&A mode(question & answer mode) after an inquiry command is
# received; The module will automatically switch to initiative upload mode if no inquiry command is received
# within 30 seconds under Q&A mode
...
class sensor:
    def __init__(self):
        ...
        self.QA_MODE_TYPE = 1
        self.GAS_TYPE = 0x04
        self.CONVERSION_FACTOR_N = 0.1*1.25 #CO/22.4
    ...
    def _caculatorGasValue(self, highByte, lowByte):  
        ppb = (highByte & 0x1F) << 8 | (lowByte & 0xFF)
